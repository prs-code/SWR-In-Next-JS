This is an example using TypeScript in the Next.js framework, where data is fetched from the server in three different pages, as an example for comparison.
